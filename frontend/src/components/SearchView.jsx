...
const SearchView = () => {
    ...
    useEffect(() => {
        if (list !== undefined && result !== undefined) {
            result.length < 100 ? setListEnded(true) : setListEnded(false);
    ...
    const modalSettings = {
        ...
        contentSettings: {
            ...
            content: function Content() {
                ...
                <p>Чтобы получить больше результатов, воспользуйтесь подсказками:</p>
                <p>
                    <ul>
                        <li>&#x2022; чтобы найти конкретный источник, укажите только его название, либо только фамилию автора и название;</li>
                        <li>&#x2022; вместо имени, отчества и фамилии автора указывайте только фамилию;</li>
                        <li>&#x2022; вместо одного длинного запроса сделайте несколько кортких с основными ключевыми словами;</li>
                        <li>&#x2022; проверяйте свой запрос на опечатки;</li>
                    </ul>
                </p>
                <p>
                ...
                <p>
                    ...
                    В базе данных представлены более 500 000 источников на русском, английском и других
        ...
        <>
            <section className="search__main">
                <section className="search__header">
                    <h1 className="search__title"><span>Более 500 000 источников</span> для вашего списка литературы</h1>
