...
const OrderForm = () => {
            ...
            content: function Content() {
                return (
                    <>
                        ...
                        <p>
                            Мы подоберем и оформим по ГОСТ подходящие источники по вашей теме. Мы выбираем источники из специализированных научных журналов, научной литературы, диссертаций, авторитетных ресурсов.
                        </p>
                        <p>
                            Укажите тему работы, необходимое количество источников и электронную почту, на которую мы отправим готовый список литературы.
                        ...
                        <p>
                            ...
                            Также мы можем оформить ваш список по другому стандарту (например, по старому стандарту ГОСТ Р 7.0.5–2008. «Библиографическая ссылка. Общие требования и правила составления» или
                            ГОСТ 7.1 - 2003. «Библиографическая запись. Библиографическое описание. Общие требования и правила составления». Для этого в поле «Информация о работе» укажите, по какому именно ГОСТу или образцу вам необходимо оформить список.
                        </p>
                        <br />
                        ...
                        <p>
                            Обращаем ваше внимание, что в течение суток может быть выполнен только список не более чем из 50 источников.
                        </p>
                        <br />
                        <h4>Стоимость списка литературы</h4>
                        <ul className="modal__list">
                            <li>1 источник <br /> <span>30 ₽</span></li>
    ...
    return (
        <Formik
            ...
            onSubmit={(values) => {
                postOrder({ ...values, price: calcPrice(values), created_at: createdAt() });
            }}>
            {({ values }) => (
                <Form className="order__form">
                    <h3 className="order__title">Заполните данные о работе:</h3>
                    ...
                    <div className="order__options">
                        ...
                        <div className="order__checkboxes">
                            ...
                            ) : <h4>Если в списке менее 50 источников, можно заказать срочное выполнение в течение одних суток.</h4>}
                            <div>
                    ...
                    {isLoading ? <SmallSpinner /> :
                        isError ? (
                            <p>
                                ...
                                Попробуйте обновить страницу и повторить попытку позже. Если ошибка не исчезнет, напишите нам, указав в письме код ошибки:
